...
class Settings(BaseSettings):
    ...
    min_tile_water_fraction_for_risk: float = 0.20
    # Keep default fully local for hackathon reliability.
    water_detector_mode: str = "spectral"  # spectral | pretrained | auto
